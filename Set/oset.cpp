...
void reader(unordered_set<string>& s);
void comparator(unordered_set<string>&);
void remover(unordered_set<string>& s);
...
int main(void) {
	...
	cout << "Time taken from unordered set is  " << seconds << endl;
...
void comparator(unordered_set<string>& s) {
	int bad = 0;
	int good = 0;
	cout << "Enter the name of the file: " << endl;
	string filename;
